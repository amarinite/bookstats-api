...
SELECT u.id, b.id, reading_data.status::reading_status, reading_data.rating, reading_data.start_date, reading_data.finish_date, reading_data.notes
FROM (VALUES
...
SELECT 'Sample Books with Correct Enums:' as info;
SELECT b.title, b.author, b.author_gender, b.published_year
FROM books b
ORDER BY b.title
LIMIT 5;

SELECT 'User Reading Stats:' as info;
